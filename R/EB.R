...
#'
#' @aliases EB
#' @param model An object of class \code{brokenstick} (typically created by
#' \code{brokenstick()}) or class \code{brokenstick.export}
...
#' lme4::ranef(fit)$subject[1,]
#' #
#' # EB estimate random effect for child id 8
#' est <- export.brokenstick(fit)
#' y <- data[data$subject == 8, "hgt.z"]
#' y
#' # X <- make.basis(data[data$subject == 8, "age"], 
#' #		knots = knots)
#' # X
#' # EB(est, y, X)
#' @export
