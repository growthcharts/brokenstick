...
The [companion site](https://stefvanbuuren.name/brokenstick/) contains various vignettes and articles that explain the model and the use of the software. The most extensive documentation is the paper [Broken Stick Model for Irregular Longitudinal Data](https://stefvanbuuren.name/brokenstick/articles/brokenstick-article.html).
