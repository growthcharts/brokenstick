...
bibliography: [vignettes/manual/bibliography.bib]
...
- Paper in preparation: *Broken Stick Model for Irregular Longitudinal Data*: [html](https://growthcharts.org/brokenstick/articles/manual/manual.html).
