...
knitr::opts_chunk$set(echo = TRUE, cache = FALSE, fig.height = 7, fig.width = 7, out.width="100%", dev = "svglite")
...
knitr::include_graphics("JAMES_tryout.pdf")
```
...
```{r curvematching4, fig.height=4, fig.cap = "Curve matching. Observed and fitted trajectories of 10 matches for subject 10001.", set.theme = TRUE, warning=FALSE}
