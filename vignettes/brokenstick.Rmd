...
The `brokenstick` package contains functions to fit, predict and plot data. See the [reference page](https://stefvanbuuren.name/brokenstick/reference/index.html) for an overview.
