...
The following plot displays the same data, but in standardised units, the Standard Deviation Scores (SDS) or $Z$-score, taken from column `hgt.z`. 
...
The $Z$-score is the height corrected for age relative to the Dutch height reference from the Fourth Dutch Growth Study. Not that this plot has substantially more resolution. In addition, the data distribution follows an approximate standard normal distribution with zero mean and unit variance. That property facilitates modelling of the height.
