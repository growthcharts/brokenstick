...
plot(fit, new_data = data, group = ids, xlab = "Age (years)", ylab = "Length (cm)")
```
...
plot(fit0, new_data = data, group = ids, xlab = "Age (years)", ylab = "Length (SDS)")
```
...
plot(fit2, data, group = ids, xlim = c(0, 2.1), xlab = "Age (years)", ylab = "Length (SDS)")
```
