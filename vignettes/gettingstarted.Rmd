...
A next step is to calculate the conditional means of the posterior distribution of the sum of fixed and random effects.
...
## Predicting from the exported model
